...
namespace Nop.Plugin.Payments.RayanWallet.Infrastructure
{
    public class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            routeBuilder.MapRoute("Plugin.Payments.RayanWallet.WalletCustomerHistory", "Plugins/PaymentRayanWallet/WalletCustomerList",
                 new { controller = "PaymentRayanWallet", action = "WalletCustomerList" });
